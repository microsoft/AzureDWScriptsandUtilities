...
### Please note that we have an enhanced version of APS to Azure Synapse Analytics (formerly Azure SQL DW) Migration Process. The enhancement has more features, runs faster, and no longer dependent on the DWScripter.exe for step 1 - CreateMPPScripts. The new version is also published at GitHub. Link below:
