...
# Updaated November 2018, Added Netezza Assessment and Changed Config file to .json in addition to previous .csv file
# Author(s): Andy Isley, Gaiye Zhou, and Mark Pryce-Maher
# Company: 
# 
# =================================================================================================================================================
# Description:
